  ...
  docs: {
    "User Manual": [
      ...
      "manual/reconciling",
      {
        ...
        items: [
          "manual/wikibase/overview",
          "manual/wikibase/configuration",
          "manual/wikibase/reconciling",
          "manual/wikibase/schema-alignment",
          "manual/wikibase/new-entities",
          "manual/wikibase/quality-assurance",
          "manual/wikibase/uploading",
        ],
      },
      {
        type: "category",
