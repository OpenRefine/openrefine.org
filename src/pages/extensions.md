...
| [Commons extension](https://github.com/OpenRefine/CommonsExtension) | Utilities to improve the process of extracting structured data from existing files on Wikimedia Commons | [Joey Salazar](https://github.com/j-sal), [Sandra Fauconnier](https://github.com/trnstlntk) | 3.6 |
| [OpenRefine Command Palette](https://codeberg.org/abbe98/openrefine-command-palette) | A command palette and keyboard acceleration extension for OpenRefine | [Albin Larsson](https://codeberg.org/abbe98) | 3.6 |
