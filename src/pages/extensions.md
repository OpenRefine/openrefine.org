...
| [GEO Extension](https://github.com/SashankBhamidi/openrefine-geo-extension) | Adds geographic coordinate processing functions: decToGMS() converts decimal degrees to degrees/minutes/seconds format, and geoDistance() calculates great circle distance between coordinate pairs using the Haversine formula. | [SashankBhamidi](https://github.com/SashankBhamidi) | 3.10+ |
