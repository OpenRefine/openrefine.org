...
We encourage extension authors to consider how their work aligns with OpenRefine’s mission, which is to build a more informed world where working with data is easy and engaging. However, this is not a strict requirement: extensions can be developed to address specific needs or experiments, and may or may not be shared publicly.
