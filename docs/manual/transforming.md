...
* change the order of [rows](#edit-rows) or [columns](columnediting#renaming-removing-and-moving)
...
* [split or join multi-valued cells](cellediting#split-multi-valued-cells)

and an especially **powerful** feature called

* [Clustering](cellediting#cluster-and-edit)
