...
The final release of 3.1 was released on Nov 29, 2018. A change log is provided on [the release page](https://github.com/OpenRefine/OpenRefine/releases/tag/3.1).

+ **[Windows kit](https://github.com/OpenRefine/OpenRefine/releases/download/3.1/openrefine-win-3.1.zip)**, 
...
+ **[Mac kit](https://github.com/OpenRefine/OpenRefine/releases/download/3.1/openrefine-mac-3.1.dmg)**, 
Download, open, drag icon into the Applications folder and double click on it. 
+ **[Linux kit](https://github.com/OpenRefine/OpenRefine/releases/download/3.1/openrefine-linux-3.1.tar.gz)**, 
Download, extract, then type _./refine_ to start.

### OpenRefine 3.1 beta
The beta release of OpenRefine 3.1. Please BACKUP your workspace directory before installing and report any problems that you encounter.

The beta of 3.1 was released on Nov 7, 2018. A change log is provided on [the release page](https://github.com/OpenRefine/OpenRefine/releases/tag/3.1-beta).

+ **[Windows kit](https://github.com/OpenRefine/OpenRefine/releases/download/3.1-beta/openrefine-win-3.1-beta.zip)**, 
Download, unzip, and double-click on _openrefine.exe_. If you're 
having issues with the above, try double-clicking on _refine.bat_ instead.
+ **[Mac kit](https://github.com/OpenRefine/OpenRefine/releases/download/3.1-beta/openrefine-mac-3.1-beta.dmg)**, 
Download, open, drag icon into the Applications folder and double click on it. 
+ **[Linux kit](https://github.com/OpenRefine/OpenRefine/releases/download/3.1-beta/openrefine-linux-3.1-beta.tar.gz)**, 
Download, extract, then type _./refine_ to start.
...
The final release of 3.0 on Sept 16, 2018. A change log is provided on [the release page](https://github.com/OpenRefine/OpenRefine/releases/tag/3.0).

+ **[Windows kit](https://github.com/OpenRefine/OpenRefine/releases/download/3.0/openrefine-win-3.0.zip)**, 
Download, unzip, and double-click on _openrefine.exe_. If you're 
having issues with the above, try double-clicking on _refine.bat_ instead.
...
|--------------|-------------|----------|
| [RDF extension v1.0.1](https://github.com/stkenny/grefine-rdf-extension/releases/tag/v1.0.1) for OpenRefine 3.0+ | RDF Refine - an improved fork of OpenRefine extension for exporting RDF |  stkenny http://www.dri.ie/ | 
