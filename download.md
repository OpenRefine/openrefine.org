...
| [Named-Entity Recognition](https://github.com/stkenny/Refine-NER-Extension) | Enriches text fields. It supports AlchemyAPI, DBpedia Lookup, and Zemanta. [Manual](http://freeyourmetadata.org/named-entity-extraction/). |  Ruben Verborgh (Free Your Metadata) and Stuart Kenny | 3.4.1 |
...
| [GOKb](https://github.com/ostephens/refine-gokbutils) | Checks a project, resolves errors and warnings, and exports data to GOKb. | [GOKb](www.gokb.org) & Owen Stephens | 3.1 |
