...
| [RDF extension 0.9](https://github.com/fadmaa/grefine-rdf-extension/releases) | RDF Refine - an older version of RDF extension for exporting RDF. |  DERI  | 2.6 |
...
| [GOKb](https://github.com/ostephens/refine-gokbutils) | The [GOKb](www.gokb.org) extension can check in a project, resolve errors and warnings, and ingest data into GOKb. | GOKb & Owen Stephens | 3.1 |
| [Crowdsourcing](https://github.com/sparkica/crowdsourcing) | For creating jobs and uploading data to CrowdFlower crowdsourcing service. |  Zemanta  | _Suggests LODRefine_ |
| [DBpedia extension](https://github.com/sparkica/dbpedia-extension) |  Add columns from DBpedia to reconciled data (columns). Data has to be reconciled with DBpedia or SPARQL endpoint, which returns DBpedia resource types. |  Zemanta | _Not working_ |
...
| [Named-Entity Recognition](https://github.com/stkenny/Refine-NER-Extension) | Enrich text fields. It supports AlchemyAPI, DBpedia Lookup, and Zemanta. [Manual](http://freeyourmetadata.org/named-entity-extraction/). |  Ruben Verborgh (Free Your Metadata) and Stuart Kenny | 3.4.1 |
