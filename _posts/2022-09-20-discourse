...
---
<img src="https://openrefine.org/images/2022-group-discussions.jpg" alt="Simple graphic showing group discussions with multicolored text balloons" class="inset" />
...
For quite a while, some active OpenRefine community members ([Antonin](https://github.com/wetneb), [Sandra](https://github.com/trnstlntk), and the [OpenRefine advisory committee](https://github.com/OpenRefine/OpenRefine/blob/master/GOVERNANCE.md)) have been talking about ways to make OpenRefine’s community more lively, active and diverse.
